...
module RbConfig
  RUBY_VERSION.start_with?("2.4.") or
    raise "ruby lib version (2.4.5) doesn't match executable version (#{RUBY_VERSION})"

  # Ruby installed directory.
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.4.0/armv7l-linux-eabihf")
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.4.5"
