...
set_target_properties(leatherman_util PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_util.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_util.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_util )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_util "${_IMPORT_PREFIX}/lib/leatherman_util.so.1.7.1" )
...
set_target_properties(leatherman_locale PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_locale.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_locale.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_locale )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_locale "${_IMPORT_PREFIX}/lib/leatherman_locale.so.1.7.1" )
...
set_target_properties(leatherman_logging PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_logging.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_logging.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_logging )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_logging "${_IMPORT_PREFIX}/lib/leatherman_logging.so.1.7.1" )
...
set_target_properties(leatherman_json_container PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_json_container.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_json_container.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_json_container )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_json_container "${_IMPORT_PREFIX}/lib/leatherman_json_container.so.1.7.1" )
...
set_target_properties(leatherman_file_util PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_file_util.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_file_util.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_file_util )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_file_util "${_IMPORT_PREFIX}/lib/leatherman_file_util.so.1.7.1" )
...
set_target_properties(leatherman_curl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_curl.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_curl.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_curl )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_curl "${_IMPORT_PREFIX}/lib/leatherman_curl.so.1.7.1" )
...
set_target_properties(leatherman_dynamic_library PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_dynamic_library.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_dynamic_library.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_dynamic_library )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_dynamic_library "${_IMPORT_PREFIX}/lib/leatherman_dynamic_library.so.1.7.1" )
...
set_target_properties(leatherman_execution PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_execution.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_execution.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_execution )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_execution "${_IMPORT_PREFIX}/lib/leatherman_execution.so.1.7.1" )
...
set_target_properties(leatherman_ruby PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/leatherman_ruby.so.1.7.1"
  IMPORTED_SONAME_RELEASE "leatherman_ruby.so.1.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS leatherman_ruby )
list(APPEND _IMPORT_CHECK_FILES_FOR_leatherman_ruby "${_IMPORT_PREFIX}/lib/leatherman_ruby.so.1.7.1" )
